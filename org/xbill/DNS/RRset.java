...
public class RRset implements Serializable {
   ...
   *
   * @param cycle If true, cycle through the records so that each Iterator will start with a
   *     different record.
   */
  ...
  /**
   * Returns an Iterator listing all (data) records. This cycles through the records, so each
   * Iterator will start with a different record.
   */
