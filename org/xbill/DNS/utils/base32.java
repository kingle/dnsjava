...
public class base32 {
   ...
   * @param lowercase Whether lowercase characters should be used. default parameters (The standard
   *     base32 alphabet, no padding, uppercase)
   */
  ...
  public String toString(byte[] b) {
    ...
    for (int i = 0; i < (b.length + 4) / 5; i++) {
      ...
      if (padding) {
        for (int j = t.length - padlen; j < t.length; j++) os.write('=');
      }
    }
