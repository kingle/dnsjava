...
public class TSIG {
  ...
  /**
   * The domain name representing the HMAC-SHA224 algorithm. Note that SHA224 is not supported by
   * Java out-of-the-box, this requires use of a third party provider like BouncyCastle.org.
   */
